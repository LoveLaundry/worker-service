...
class DailyLogUpdate(BaseModel):
    ...
    washed_count: Optional[int] = None
    pressed_count: Optional[int] = None
    folded_count: Optional[int] = None
    packed_count: Optional[int] = None
    other_count: Optional[int] = None
    total_weight_kg: Optional[float] = None
    tasks: Optional[list[TaskEntry]] = None
    rewash_count: Optional[int] = None
    damaged_items: Optional[int] = None
